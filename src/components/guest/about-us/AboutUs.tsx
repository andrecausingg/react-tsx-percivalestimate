...
const AboutUs: React.FC = () => {
  return (
    <>
      <div className="grid md:grid-cols-2 items-center font-gilroyLight md:max-w-3xl xl:max-w-6xl py-4 px-6 mx-auto mt-24 gap-4">
        <div>
          <h6 className="text-orangeClient">About Us</h6>
          <h1 className="my-4 text-2xl lg:text-4xl font-gilroyExtraBold text-darkBlueClient">
            With our techniques, we guarantee cost savings <br />
            <span className="text-sm text-greenClient">
